...
function findWasmBinary() {
  return locateFile('vidyax_vm.wasm');
}
...
var _run_from_js = Module['_run_from_js'] = makeInvalidEarlyAccess('_run_from_js');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['run_from_js'] != 'undefined', 'missing Wasm export: run_from_js');
  ...
  _run_from_js = Module['_run_from_js'] = createExportWrapper('run_from_js', wasmExports['run_from_js'], 1);
